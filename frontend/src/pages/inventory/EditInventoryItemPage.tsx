...
export default function EditInventoryItemPage() {
  ...
  const updateMutation = useMutation({
    mutationFn: (data: UpdateInventoryInput) => inventoryService.update(id!, data),
    onSuccess: async () => {
    ...
    return (
      <div className="container mx-auto py-6 max-w-4xl">
        <Alert variant="destructive">
          <AlertDescription>
            حدث خطأ في تحميل بيانات الصنف. يرجى المحاولة مرة أخرى.
          </AlertDescription>
        </Alert>
        <Button variant="outline" onClick={handleCancel} className="mt-4">
          العودة إلى قائمة المخزون
        </Button>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto py-6 max-w-4xl">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold">تعديل صنف</h1>
          <p className="text-muted-foreground">تعديل بيانات {item.name}</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>قم بتعديل البيانات الرئيسية للصنف</CardDescription>
          </CardHeader>
